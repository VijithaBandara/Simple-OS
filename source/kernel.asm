...
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to Viji_OS Version 1.0.1 - Enter help to display commands", 0x00
	strPrompt		db	"Viji>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Viji", 0x00	;OS details
	strMajorVer		db	"8", 0x00
	...
	strHelpMsg1		db  "enter version to display version",0x00
	strHelpMsg2		db  "enter info to display Hardware informations of the system",0x00
	strHelpMsg3		db  "enter exit to restart the system",0x00
